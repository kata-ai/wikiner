...
from ingredients.crf_utils import sent2lessfeatures
...
def train(train_corpus: str, dev_corpus: str,
    ...
    X_train = [sent2lessfeatures(s, window_size) for s in train_sents]
    y_train = [sent2labels(s) for s in train_sents]

    X_dev = [sent2lessfeatures(s, window_size) for s in dev_sents]
...
def test(model_filename: str, test_corpus: str, window_size: int = 5, 
    ...
    X_test = [sent2lessfeatures(s, window_size) for s in test_sents]
